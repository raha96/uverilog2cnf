...
\begin{document}
    ...
    \lstinputlisting[caption={Sample cnflib},label={lst:cnflib} ]{doc/sample.cnflib}
    ...
    \lstinputlisting[caption={Sample sol file},label={lst:sol} ]{doc/sample.sol}
    ...
    \lstinputlisting[caption={Sample card file},label={lst:card} ]{doc/sample.card}
